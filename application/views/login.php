...
<div class="container-narrow">
    ...
    <div class="masthead">
        <div class="pull-left">
            <span><a style="vertical-align: bottom;" href="<?php echo site_url();?>">返回首页</a></span>
        </div>
        <div class="user_nav pull-right">
            <a type="button" class="btn btn-default" role="button" href="<?php echo site_url('login');?>">登录</a>
            <a type="button" class="btn btn-default" role="button" href="<?php echo site_url('register');?>">注册</a>
        </div>
    ...
    <div class="container high well">
        ...
        <form class="form-signin" role="form" action="login/dologin" method="post">
            <h2 class="form-signin-heading">用户登录</h2>
            <input type="text" class="form-control" placeholder="用户名或Email" required="" autofocus="" name="username">
        ...
        <div class="alert  noaccount center-block">
            <p class="text-center">
                还没有帐号？<a href="<?php echo site_url('register');?>">注册</a>
            </p>
