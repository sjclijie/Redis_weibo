...
<html lang="zh-cn"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="<?=base_url()?>static/css/bootstrap-theme.min.css">
    <link rel="stylesheet" href="<?=base_url()?>static/css/mybase.css">
  ...
  <body>
	...
	<form class="form-inline" role="form" action="<?=site_url('home/publish')?>" method="post">
