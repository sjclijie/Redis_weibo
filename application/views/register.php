...
<div class="container-narrow">
    <div class="masthead">
        <div class="pull-left"><span><a style="vertical-align: bottom;" href="<?php echo site_url();?>">返回首页</a></span></div>
        <div class="user_nav pull-right"><a type="button" role="button" href="<?php echo site_url('login');?>" class="btn btn-default">登录</a><a type="button" role="button" href="<?php echo site_url('register');?>" class="btn btn-default">注册</a></div>
    </div>
    <div class="clearfix"></div>
    <hr>
    <div class="container high well">
        <form id="form" role="form" action="<?php echo site_url('register/doreg');?>" method="post" class="form-signin">
        ...
        <div class="alert noaccount center-block">
            <p class="text-center">已有账号，<a href="<?php echo site_url('login');?>">登录</a></p>
        </div>
    </div>
    <div class="footer">
